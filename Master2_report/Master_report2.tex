...
\usepackage{.temp/setup}

\makeatletter
\newcommand\logolab[1]{\def\@logolab{\includegraphics[width=0.5\linewidth,left]{#1}}}
\newcommand\tutor[1]{\def\@tutor{#1}}
\newcommand\labo[1]{\def\@labo{#1}}
\newcommand\team[1]{\def\@team{#1}}
\newcommand\labadr[1]{\def\@labadr{\footnotesize #1}}
\newcommand\pict[1]{\def\@pict{\includegraphics[height = 7.5cm]{#1}}}
\newcommand\credpict[1]{\def\@credpict{#1}}
\newcommand\email[1]{\def\@email{#1}}
\newcommand\souten[1]{\def\@date{\today~|  Soutenance : #1}}
\makeatother

\logolab{fig/leca.jpg}
...
% Quick set up
\usepackage{ifthen} \newboolean{notes} \newboolean{terminal} \newboolean{counter}
\setboolean{notes}{false} \setboolean{terminal}{false}  \setboolean{counter}{false}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Informations :
%\title{\textbf{Title du Stage : this is a very long title to test the page}}
%\author{Maxime Jaunatre $^1$}
%\date{\today~|  Soutenance : mardi X juin 2020 }
